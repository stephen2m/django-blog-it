...
urlpatterns = [
    ...
    url(r'^view/(?P<blog_slug>[-\w]+)/$', PostDetailView.as_view(),
        name='view_blog'),
    url(r'^delete/(?P<blog_slug>[-\w]+)/$', PostDeleteView.as_view(),
        name='delete_blog'),
    ...
    url(r'^delete_category/(?P<category_slug>[-\w]+)/$', delete_category,
        name='delete_category'),
    url(r'^edit_category/(?P<category_slug>[-\w]+)/$', edit_category,
        name='edit_category'),
